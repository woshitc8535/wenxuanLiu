...
def parse_file(path, encode='utf-8'):
    ...
    with open(path, 'r', encoding=encode) as ged_file:
        ...
        for line in ged_file:
            ...
            if isValid == 'Y':  # only read the valid line
                ...
                if IsIND:  # information about the individual if true
                    ...
                    if level == '1' and tag in (
                    'FAMC', 'FAMS'):  # store family information: child in the family, or spouse in the family
                ...
                if IsIND == False:
                    if level == '1' and word_list[1] == 'MARR' or word_list[
                        1] == 'DIV':  # store marriage date and divorce date
                        currentDate = tag
        ...
        for key in indi.keys():
            ...
            indiTable.add_row(
                [indi[key]['id'], indi[key]['name'], indi[key]['sex'], birth_str, age, death_str, child, spouse])
...
r = parse_file('C:\\Users\\woshi\\PycharmProjects\\untitled1\\Teamproject\\My-Family-27-Jan-2019-230.ged')
# r=parse_file('D:\workspace\sample_test.ged')
#print(r)
# if __name__ == '__main__':
#     Marrige_before_Divorce(r)